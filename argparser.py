...
parser.add_argument('-f', '--filename', action='store', type=str, default="test",
                        help='File name.')
...
parser.add_argument('--dim', action='store', metavar='INT', type=int, default=64,
                    help='Dimension of the latent space, default = 64.')
...
parser.add_argument('--learning_rate', action='store', metavar='FLOAT', type=float, default=0.001,
...
parser.add_argument('--seq_len', action='store', metavar='INT', type=int, default=200,
                    help='Length of the input sequences to the network, default: 200')
